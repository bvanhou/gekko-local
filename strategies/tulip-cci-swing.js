...
method.check = function(candle) {
  ...
  const crossLongVar = crossLong(this.prevEmaShort, this.prevEmaMiddle, emaShort, emaMiddle, candle);
  if(!this.hasBought
      && (
...
function crossLong(prev1, prev2, current1, current2, candle){
...
function crossShort(prev1, prev2, current1, current2){
  return prev1>prev2 && current1<current2;
}
